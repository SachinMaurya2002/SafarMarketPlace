...
import 'package:safar_store/features/shop/models/cart_item_model.dart';
...
class CartController extends GetxController {
  ...
  void addToCart(ProductModel product) {
    ...
    // Check Variation of the product if it is variable product
    ...
    if (product.productType == ProductType.variable.toString()) {
      if (variationController.selectedVariation.value.stock < 1) {
        USnackBarHelpers.warningSnackBar(
          title: 'Out Of Stock',
          message: 'This Variation is out of stock. Please visit again!',
        );
        return;
      }
    } else {
      if (product.stock < 1) {
        USnackBarHelpers.warningSnackBar(
          title: 'Out Of Stock',
          message: 'This Product is out of stock. Please visit again!',
        );
      }
    }
  ...
  // Get Variation quantity of the specific product
  ...
  // Initialize alraedy added items count in the cart
